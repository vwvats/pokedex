import { _ as __extends, v as visit, a as __assign, b as __spreadArrays, f as fastJsonStableStringify, z as zenObservable, d as __awaiter, e as __generator, B as BREAK, p as print, c as __rest } from './common/index-5835df6c.js';
...
function shouldInclude(selection, variables) {
    ...
    return getInclusionDirectives(selection.directives).every(function (_a) {
        ...
        if (ifArgument.value.kind === 'Variable') {
            ...
            invariant(evaledValue !== void 0, 13) ;
        }
        else {
...
function getInclusionDirectives(directives) {
    return directives ? directives.filter(isInclusionDirective).map(function (directive) {
        ...
        invariant(directiveArguments && directiveArguments.length === 1, 14) ;
        var ifArgument = directiveArguments[0];
        invariant(ifArgument.name && ifArgument.name.value === 'if', 15) ;
        var ifValue = ifArgument.value;
        invariant(ifValue &&
            (ifValue.kind === 'Variable' || ifValue.kind === 'BooleanValue'), 16) ;
...
function getFragmentQueryDocument(document, fragmentName) {
    ...
    if (typeof actualFragmentName === 'undefined') {
        invariant(fragments.length === 1, 12) ;
...
function checkDocument(doc) {
    invariant(doc && doc.kind === 'Document', 2) ;
    ...
    invariant(operations.length <= 1, 4) ;
    return doc;
}
...
function getQueryDefinition(doc) {
    ...
    invariant(queryDef && queryDef.operation === 'query', 6) ;
    return queryDef;
}
function getFragmentDefinition(doc) {
    invariant(doc.kind === 'Document', 7) ;
    invariant(doc.definitions.length <= 1, 8) ;
    var fragmentDef = doc.definitions[0];
    invariant(fragmentDef.kind === 'FragmentDefinition', 9) ;
    return fragmentDef;
}
            ...
            : onError(function (_a) {
                ...
                if (graphQLErrors) {
                    graphQLErrors.forEach(function (_a) {
                        ...
                        return "production" === "production" || invariant.warn("[GraphQL error]: Message: " + message + ", Location: " +
                            (locations + ", Path: " + path));
                    });
                }
                if (networkError) {
                    "production" === "production" || invariant.warn("[Network error]: " + networkError);
                }
            });
